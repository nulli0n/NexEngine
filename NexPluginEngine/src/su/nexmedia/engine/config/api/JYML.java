...
public class JYML extends YamlConfiguration {
    ...
    public <T extends Enum<T>> GuiItem getGuiItem(@NotNull String path, @Nullable Class<T> clazzEnum) {
        ...
        GuiItem guiItem = new GuiItem(id, type, item, animAutoPlay, animStartFrame, animFrames, customClicks,
                permission, slots);
    ...
    public void setItem(@NotNull String path, @Nullable ItemStack item) {
        ...
        if (color != null) {
            colorRaw = new StringBuilder().append(color.getRed()).append(",").append(color.getGreen()).append(",")
