...
public class ActionSection {
    ...
    public ActionSection(@NotNull List<String> targetSelectors, @NotNull List<String> conditionList,
            @NotNull String conditionActionOnFail, @NotNull List<String> actionExecutors) {
