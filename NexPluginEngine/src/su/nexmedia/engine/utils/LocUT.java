...
public class LocUT {
    ...
    public static String serialize(@NotNull Location loc) {
        ...
        StringBuilder raw = new StringBuilder().append(loc.getX()).append(",").append(loc.getY()).append(",")
                .append(loc.getZ()).append(",").append(loc.getPitch()).append(",").append(loc.getYaw()).append(",")
    ...
    public static Location getCenter(@NotNull Location loc, boolean vert) {
        ...
        loc = new Location(loc.getWorld(), getRelativeCoord(loc.getBlockX()),
                vert ? getRelativeCoord(loc.getBlockY()) : loc.getBlockY(), getRelativeCoord(loc.getBlockZ()));
