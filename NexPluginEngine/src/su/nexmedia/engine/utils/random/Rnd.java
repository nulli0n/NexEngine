...
public class Rnd {
    ...
    static {
        ...
        MATERIAL_COLORS = Arrays.asList("WHITE", "BLACK", "ORANGE", "YELLOW", "RED", "GREEN", "LIME", "BLUE", "CYAN",
                "BROWN", "GRAY", "PURPLE", "PINK", "MAGENTA", "LIGHT_GRAY", "LIGHT_BLUE");
    }
    ...
    public static Firework spawnRandomFirework(@NotNull Location loc) {
        ...
        FireworkEffect effect = FireworkEffect.builder().flicker(Rnd.nextBoolean()).withColor(c1).withFade(c2)
                .with(type).trail(Rnd.nextBoolean()).build();
