...
public class EditorManager {
    ...
    public static void sendClickableTips(@NotNull Player player, @NotNull Collection<String> items2) {
        if (items2.size() >= 100) {
            List<List<String>> split = CollectionsUT.split(items2.stream().collect(Collectors.toList()), 50);
    ...
    public static void endEdit(@NotNull Player player, boolean msg) {
        ...
        player.sendTitle(ENGINE.lang().Core_Editor_Display_Done_Title.getMsg(), "", 10, 40, 10);
    }
    ...
    public static void tipCustom(@NotNull Player player, @NotNull String sub) {
        EditorManager.tip(player, ENGINE.lang().Core_Editor_Display_Edit_Title.getMsg(), sub);
    }
    ...
    public static void errorNumber(@NotNull Player player, boolean mustDecimal) {
        ...
        EditorManager.tip(player, title, sub);
    }

    public static void errorCustom(@NotNull Player player, @NotNull String sub) {
        EditorManager.tip(player, ENGINE.lang().Core_Editor_Display_Error_Title.getMsg(), sub);
    }
